...
const makeStyles = (C) => StyleSheet.create({
  ...
  markAll:  { fontSize: fs(7.5), fontWeight: '600', color: C.textMuted },

  center: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  empty:  { fontSize: fs(13), color: C.textMuted },

  listContent: { paddingHorizontal: ms(12), paddingVertical: vs(6), gap: vs(3) },
  item: {
    flexDirection: 'row', alignItems: 'flex-start', gap: ms(7),
    paddingVertical: vs(7), paddingHorizontal: ms(8),
  },
  itemUnread: { backgroundColor: C.surface, borderLeftWidth: 2, borderLeftColor: C.accent, borderRadius: ms(10) },
  itemRead:   {},
  avatar: { width: s(28), height: s(28), borderRadius: s(14), alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  avatarText: { fontSize: fs(8.5), fontWeight: '800' },
  content: { flex: 1, minWidth: 0 },
  lineText: { fontSize: fs(8), lineHeight: fs(12) },
  preview:  { fontSize: fs(7), color: C.textMuted, marginTop: vs(1) },
  time:     { fontSize: fs(6.5), color: C.textMuted, marginTop: vs(1) },
});
